========================
saltstack-kibana-formula
========================

.. image:: http://img.shields.io/github/tag/bechtoldt/saltstack-kibana-formula.svg
    :target: https://github.com/bechtoldt/saltstack-kibana-formula/tags

.. image:: http://issuestats.com/github/bechtoldt/saltstack-kibana-formula/badge/issue
    :target: http://issuestats.com/github/bechtoldt/saltstack-kibana-formula

.. image:: https://api.flattr.com/button/flattr-badge-large.png
    :target: https://flattr.com/submit/auto?user_id=bechtoldt&url=https%3A%2F%2Fgithub.com%2Fbechtoldt%2Fsaltstack-kibana-formula

SaltStack formula to set up and configure Kibana, a data visualization platform
...
Take a look at older `releases <https://github.com/bechtoldt/saltstack-kibana-formula/releases>`_ to get a version that isn't using the formhelper
yet (if any).
...
But it’s better to `file an issue <https://github.com/bechtoldt/saltstack-kibana-formula/issues/new>`_ with your idea first.
